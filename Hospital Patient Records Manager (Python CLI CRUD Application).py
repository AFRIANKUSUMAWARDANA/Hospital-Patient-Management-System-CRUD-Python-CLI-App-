...
# Data Pasien merupakan bagian dari dictionary dalam list
...
# 2.2 Menu input data pasien baru                                                  # Menginput data pasien baru berupa nama,jk,tl,tanggungan,perawatan,dan proses
...
def inputTanggungan(dataBaru):                                         # Input Tanggungan ada 2 opsi BPJS dan Tanpa BPJS
    while True:
        ...
        if Tanggungan == '1':
            ...
            print('===== Masukkan salah satu dari pilihan ❌ =====')               
...
def ubahData_Pasien(nomorKP):
    ...
    return pasien
# 3.1.2 Pilih Kolom Update                                                                 # Update kolom berdasarkan key di list data pasien 
